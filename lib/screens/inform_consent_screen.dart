  ...
  Future<void> _saveConsent() async {
    if (!_hasRead) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Harap baca dan centang pernyataan persetujuan terlebih dahulu.',
    ...
    if (_signatureController.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Harap buat tanda tangan terlebih dahulu.',
            style: GoogleFonts.manrope(),
          ),
          backgroundColor: Colors.orange,
          behavior: SnackBarBehavior.floating,
                ...
                children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Baca dan tandatangani sebelum melanjutkan',
                                style: GoogleFonts.manrope(
                                  fontSize: 11,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'SURAT PERSETUJUAN PROGRAM DIET',
                          style: GoogleFonts.manrope(
                            fontSize: 13,
                            fontWeight: FontWeight.w700,
                            color: AppColors.textPrimary,
